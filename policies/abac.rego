...
# NOTE: Generic read/write rules removed - they were too permissive.
# IP-based restrictions should only DENY or ADD conditions, not broadly ALLOW.

# Admin operations from trusted IPs get additional access
allow if {
    helpers.is_admin
...
# Super admins from trusted IPs can do anything
allow if {
    helpers.is_super_admin
    helpers.is_trusted_ip
}
